...
public class DAS {
    ...
    private void initializeMap() {
        ...
        distanceMap.put(1.7, new MotorSettings(9.5, 2700));
        distanceMap.put(2.0, new MotorSettings(14, 2700));
        distanceMap.put(2.3, new MotorSettings(18.5, 2850));
        distanceMap.put(2.6, new MotorSettings(18.5, 2900));
        distanceMap.put(2.9, new MotorSettings(18.5, 3000));
        distanceMap.put(3.2, new MotorSettings(18.5, 3100));
        distanceMap.put(3.5, new MotorSettings(23.5, 3100));
        distanceMap.put(3.8, new MotorSettings(23.5, 3250));
        distanceMap.put(4.1, new MotorSettings(23.5, 3350));
        distanceMap.put(4.4, new MotorSettings(27, 3450));
        distanceMap.put(4.7, new MotorSettings(32, 3450));
        distanceMap.put(5.0, new MotorSettings(32, 3550));
        distanceMap.put(5.3, new MotorSettings(37, 3600));
        distanceMap.put(5.6, new MotorSettings(37, 3700));
    }
