...
public class AbsoluteFieldDrive extends Command {
   ...
   *          deadband already accounted for. Positive X is away from the alliance
   *          wall.
   * @param vY
   *          DoubleSupplier that supplies the y-translation joystick input.
   *          Should be in the range -1 to 1 with
   *          deadband already accounted for. Positive Y is towards the left wall
   *          when looking through the driver
   *          station glass.
   * @param heading
